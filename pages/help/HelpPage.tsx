          ...
          return (
            <Card key={index} className="overflow-hidden">
              <button
                ...
                className="w-full px-6 py-5 text-left flex items-center justify-between gap-4 hover:bg-rose-50/50 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gold-200 focus:ring-offset-2 rounded-3xl"
